    ...
    <form method="POST" action="{{ route('admin.products.store') }}">
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Wireless Earbuds Pro"/>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label>Original Price (₱) <span style="color:var(--text-muted);font-weight:400;">(for discount display)</span></label>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <div class="hint">Use an image URL from Unsplash or any public image host.</div>
                </div>
            </div>
            <div class="form-row">
